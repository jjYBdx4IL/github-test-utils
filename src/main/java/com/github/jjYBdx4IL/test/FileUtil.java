...
public class FileUtil {
    ...
    public static File getMavenTargetDir() {
        ...
        if (basedir == null && System.getProperty("sun.java.command").startsWith("org.eclipse.jdt.internal.junit.runner.RemoteTestRunner ")) {
    ...
    /**
     * Creates an empty directory at ${basedir}/target/{testClassName} and cleans it if necessary. Requires to
     * be executed via maven. If the directory exists, it will be emptied.
     *
     * @param klazz
     * @return
     */
